...
import (
	...
	"github.com/edgewize-io/edgewize/pkg/client/clientset/versioned/fake"
	"github.com/edgewize-io/edgewize/pkg/client/informers/externalversions"
)

var clusters = []*infrav1alpha1.Cluster{
	{
...
func clustersToInterface(clusters ...*infrav1alpha1.Cluster) []interface{} {
...
func clustersToRuntimeObject(clusters ...*infrav1alpha1.Cluster) []runtime.Object {
...
func TestClustersGetter(t *testing.T) {
	...
	for _, cluster := range clusters {
		informer.Infra().V1alpha1().Clusters().Informer().GetIndexer().Add(cluster)
	}
