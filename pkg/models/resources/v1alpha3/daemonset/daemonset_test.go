...
var (
	foo1 = &appsv1.DaemonSet{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "foo1",
			Namespace: "bar",
		},
	}
	foo2 = &appsv1.DaemonSet{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "foo2",
			Namespace: "bar",
		},
	}
	bar1 = &appsv1.DaemonSet{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "bar1",
			Namespace: "bar",
		},
	...
	daemonSets = []interface{}{foo1, foo2, bar1}
)
...
func prepare() v1alpha3.Interface {
	...
	for _, daemonSet := range daemonSets {
		informer.Apps().V1().DaemonSets().Informer().GetIndexer().Add(daemonSet)
	}
