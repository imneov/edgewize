...
var apptemplatesResource = schema.GroupVersionResource{Group: "apps.edgewize.io", Version: "v1alpha1", Resource: "apptemplates"}

var apptemplatesKind = schema.GroupVersionKind{Group: "apps.edgewize.io", Version: "v1alpha1", Kind: "AppTemplate"}
...
func (c *FakeAppTemplates) UpdateStatus(ctx context.Context, appTemplate *v1alpha1.AppTemplate, opts v1.UpdateOptions) (*v1alpha1.AppTemplate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(apptemplatesResource, "status", appTemplate), &v1alpha1.AppTemplate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AppTemplate), err
