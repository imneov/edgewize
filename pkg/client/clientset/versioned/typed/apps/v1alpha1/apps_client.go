...
func (c *AppsV1alpha1Client) AppTemplates() AppTemplateInterface {
	return newAppTemplates(c)
}

func (c *AppsV1alpha1Client) AppTemplateVersions() AppTemplateVersionInterface {
	return newAppTemplateVersions(c)
}
