...
var clustersResource = schema.GroupVersionResource{Group: "infra.edgewize.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "infra.edgewize.io", Version: "v1alpha1", Kind: "Cluster"}
