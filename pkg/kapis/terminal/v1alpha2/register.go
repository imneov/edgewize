...
func AddToContainer(c *restful.Container, client kubernetes.Interface, config *rest.Config, options *terminal.Options) error {

	webservice := runtime.NewWebService(GroupVersion)

	handler := newTerminalHandler(client, config, options)
