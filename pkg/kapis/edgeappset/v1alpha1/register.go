...
import (
	...
	kapialertingv2beta1 "github.com/edgewize-io/edgewize/pkg/api/alerting/v2beta1"
...
func AddToContainer(container *restful.Container, informers informers.InformerFactory) error {

	ws := runtime.NewWebService(appsv1alpha1.SchemeGroupVersion)

	handler := newHandler(informers)
