...
{{- define "router-manager-edge.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.routerManagerEdge.image "global" .Values.global) }}
{{- end -}}
...
*/}}
{{- define "router-manager.imagePullSecrets" -}}
{{- include "common.images.pullSecrets" (dict "images" (list .Values.routerManager.image) "global" .Values.global) -}}
{{- end -}}

{{- define "router-manager-edge.imagePullSecrets" -}}
{{- include "common.images.pullSecrets" (dict "images" (list .Values.routerManagerEdge.image) "global" .Values.global) -}}
{{- end -}}
