...
Common labels
*/}}
{{- define "edgewize.labels" -}}
helm.sh/chart: {{ include "edgewize.chart" . }}
{{ include "edgewize.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "edgewize.selectorLabels" -}}
app.kubernetes.io/name: {{ include "edgewize.name" . }}
...
*/}}
{{- define "edgewize.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
    {{- default (include "edgewize.fullname" .) .Values.serviceAccount.name }}
{{- else }}
